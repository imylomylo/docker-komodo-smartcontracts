...
sudo docker run -it -p 7771:7771 --mount src=/home/${USER}/docker-komodod-smartcontracts/node,target=/root/.komodo,type=bind --mount src=/home/${USER}/.zcash-params,target=/root/.zcash-params,type=bind kmd-cc
